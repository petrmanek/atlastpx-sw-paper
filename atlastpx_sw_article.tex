...
The produced files are utilized as a database by the Data Visualization Application. In addition, these files serve as a starting point for other analysis tasks such as luminosity monitoring~\cite{Sopczak2017}. The original data files are compressed and downloaded to a backup medium for archivation.
